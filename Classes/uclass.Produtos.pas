...
begin
  ...
  begin
    try
      ...
      DmPedido.QrySalvarProdutos.ParamByName('cod_produto').AsInteger := DmPedido.Cdsprodutosvendacod_produto.AsInteger;
      DmPedido.QrySalvarProdutos.ParamByName('qtd').AsInteger         := DmPedido.CdsprodutosvendaQTD.AsInteger;
      DmPedido.QrySalvarProdutos.ParamByName('vl_unit').AsFloat       := DmPedido.Cdsprodutosvendavl_unit.AsFloat;
      DmPedido.QrySalvarProdutos.ParamByName('vl_total').AsFloat      := DmPedido.CdsprodutosvendaQTD.AsInteger  * DmPedido.Cdsprodutosvendavl_unit.AsFloat;
  ...
  begin
    try
      ...
      DmPedido.QrySalvarProdutos.Sql.Clear;
      DmPedido.QrySalvarProdutos.Sql.Add('Start transaction;');
      DmPedido.QrySalvarProdutos.Sql.Add('UPDATE prod_pedido SET qtd = :qtd,vl_unit = :vl_unit,vl_total = :vl_total ' +
                                         'where prod_pedido.nro_pedido = :pedido and  '+
                                         'prod_pedido.cod_produto = :produto');

      DmPedido.QrySalvarProdutos.ParamByName('qtd').AsInteger         := DmPedido.CdsprodutosvendaQTD.AsInteger;
      DmPedido.QrySalvarProdutos.ParamByName('vl_unit').AsFloat       := DmPedido.Cdsprodutosvendavl_unit.AsFloat;
      DmPedido.QrySalvarProdutos.ParamByName('vl_total').AsFloat      := DmPedido.CdsprodutosvendaQTD.AsInteger * DmPedido.Cdsprodutosvendavl_unit.AsFloat;
      DmPedido.QrySalvarProdutos.ParamByName('pedido').AsInteger      := DmPedido.Cdsprodutosvendanro_pedido.AsInteger;
      DmPedido.QrySalvarProdutos.ParamByName('produto').AsInteger     := DmPedido.Cdsprodutosvendacod_produto.AsInteger;
      DmPedido.QrySalvarProdutos.ExecSQL;
