...
uses
  ...
  public
    ...
    function EditarPedidoCompleto: String;
...
function TPedido.EditarPedidoCompleto: String;
begin
  try
    DmPedido.QryPedido.Close;
    DmPedido.QryPedido.SQL.Clear;
    DmPedido.QryPedido.SQL.Text := 'Select * from dados_gerais_pedidos where nro_pedido = :nro_pedido';
    DmPedido.QryPedido.ParamByName('nro_pedido').AsInteger := DmPedido.QrydetalhePedidonro_pedido.AsInteger;
